...
//             LOG(INFO) << "Gamepad mappings are up to date";
//         }
//         else {
...
//             LOG(INFO) << "Downloaded updated gamepad mappings";
//         }
//     }
//     else {
//         LOG(WARNING) << "Failed to download updated gamepad mappings:" << reply->error();
//         reply->deleteLater();
//     }
// }
