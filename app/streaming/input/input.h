...
public:
    ...
    static
    std::string getUnmappedGamepads();
...
private:
    ...
    std::set<short> m_KeysDown;
    bool m_FakeCaptureActive;
    std::string m_OldIgnoreDevices;
    std::string m_OldIgnoreDevicesExcept;
    std::list<std::string> m_IgnoreDeviceGuids;
