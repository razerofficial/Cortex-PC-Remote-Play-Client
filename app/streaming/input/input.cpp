      ...
      m_NumFingersDown(0)
{
    ...
    m_SpecialKeyCombos[KeyComboUngrabInput].enabled = true;
    ...
    m_SpecialKeyCombos[KeyComboToggleFullScreen].enabled = true;
    ...
    m_SpecialKeyCombos[KeyComboToggleMinimize].enabled = true;
    ...
    const char* hintgid = SDL_GetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES);
    if(nullptr != hintgid)
    {
        m_OldIgnoreDevices = hintgid;
    }
    const char* hintgide = SDL_GetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT);
    if(nullptr != hintgide)
    {
        m_OldIgnoreDevicesExcept = hintgide;
    }
    ...
    std::string streamIgnoreDevices;
    std::string streamIgnoreDevicesExcept;

    if (!streamIgnoreDevices.empty() && !WMUtils::endsWith(streamIgnoreDevices, ",")) {
        streamIgnoreDevices += ',';
    }
    ...
    std::string streamIgnoreDeviceGuids;
...
// #endif
    ...
    SDL_SetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES, streamIgnoreDevices.data());
    SDL_SetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT, streamIgnoreDevicesExcept.data());
...
SdlInputHandler::~SdlInputHandler()
{
    ...
    SDL_SetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES, m_OldIgnoreDevices.data());
    SDL_SetHint(SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT, m_OldIgnoreDevicesExcept.data());
