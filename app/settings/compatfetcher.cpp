...
//         LOG(WARNING) << "Failed to parse GFE version:" << gfeVersion.toStdString();
//         return true;
//     }

//     if (latestSupportedVersionQuad.count() <= 1) {
//         LOG(WARNING) << "Failed to parse latest supported version:" << latestSupportedVersion.toStdString();
//         return true;
//     }
...
//             LOG(WARNING) << "GFE version" << gfeVersion.toStdString() << "is not supported by this version of Moonlight";
//             return false;
//         }
//     }
// }
...
//         LOG(INFO) << "Latest supported GFE server:" << version.toStdString();
//     }
//     else {
//         LOG(WARNING) << "Failed to download latest compatibility data:" << reply->error();
//         reply->deleteLater();
//     }
// }
