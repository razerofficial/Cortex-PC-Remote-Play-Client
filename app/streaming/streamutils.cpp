...
#if (__has_builtin(__builtin_cpu_supports) || (defined(__GNUC__) && __GNUC__ >= 6)) && (defined(__x86_64) || defined(__x86_64__) || defined(__amd64) || defined(_M_X64))
...
#elif defined(_MSC_VER) && (defined(__x86_64) || defined(__x86_64__) || defined(__amd64) || defined(_M_X64))
    int regs[4];
    __cpuid(regs, 1);
